...
var SPELL_CHECK_API_URL = 'https://api.cognitive.microsoft.com/bing/v7.0/spellcheck',//'https://api.cognitive.microsoft.com/bing/v5.0/spellcheck/?form=BCSSCK',
    SPELL_CHECK_API_KEY = 'e2e9a1f63e4740e69c776a7a90ccb9dd'; //process.env.BING_SPELL_CHECK_API_KEY;
        ...
        function (resolve, reject) {
            if (text) {
                var requestData = {
                    ...
                    headers: {
                        "Ocp-Apim-Subscription-Key": '6e625974f19244d6829c6bc901d70c85'
                    },
                    form: {
                        text: text
                    },
